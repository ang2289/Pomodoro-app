...
export default function TermsPage() {
  ...
  return (
    <div className="p-6 max-w-3xl mx-auto text-gray-800 leading-relaxed">
      ...
      {/* 服務條款 - 點數購買說明 */}
      <h2 className="text-lg font-semibold mt-4 mb-2">點數購買服務條款</h2>
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
        ...
        <ul className="list-disc ml-5 space-y-2 text-blue-800 text-sm">
          <li><strong>點數為一次性購買</strong>：購買的點數為一次性消費，不會自動續費或重複扣款</li>
          <li><strong>不限使用期限</strong>：購買的點數沒有使用期限，可隨時使用</li>
          <li><strong>用完為止</strong>：點數依實際使用的文字量扣除，用完後需再次購買才能繼續使用</li>
          <li><strong>不提供退費</strong>：點數一旦購買，除非服務發生重大問題，否則不提供退款服務</li>
        </ul>
      </div>
