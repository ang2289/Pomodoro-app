...
// 準備匯出資料
export const prepareExportData = (task, registrations) => {
...
// 匯出報名名單（CSV）
export const exportRegistrationList = (task, registrations) => {
    try {
...
// 匯出報名名單（JSON）
export const exportRegistrationListJSON = (task, registrations) => {
    try {
        const data = prepareExportData(task, registrations);
