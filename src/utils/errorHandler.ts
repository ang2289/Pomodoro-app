...
// 錯誤處理函數
export function handleError(error: unknown, type: ErrorType = ErrorType.UNKNOWN): AppError {
...
// 處理並記錄錯誤，返回使用者友善的訊息
export function processError(error: unknown, type: ErrorType = ErrorType.UNKNOWN): string {
