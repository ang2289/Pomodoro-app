...
OUT = Path(r"D:\Pomodoro-app\output\waterdrop-hair-salon-32")
...
def main() -> None:
    ...
    for source in SOURCES:
        ...
        for row in range(4):
            for col in range(4):
                ...
                final = trim_and_place(remove_green_key(cell), (370, 320), 8)
    ...
    zip_path = OUT / "waterdrop-hair-salon-32-line-pack.zip"
