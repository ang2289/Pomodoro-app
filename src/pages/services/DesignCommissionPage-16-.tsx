...
const services: Service[] = [
  {
    ...
    eyebrow: "社群・電商・菜單",
    title: "商品圖升級",
    summary: "把手機拍攝的商品照整理成更適合貼文、菜單、賣場與品牌介紹的視覺。",
    price: "單張 NT$299 起",
    accent: "from-amber-500 to-orange-500",
    icon: Image,
    deliverables: ["光線、背景與構圖整理", "依用途安排版面尺寸", "JPG／PNG 成品", "一次小幅文字或版面修改"],
    suitableFor: "甜點、飲料、手作商品、團購、電商與個人賣家",
  },
  {
    id: "model-product",
    eyebrow: "男模・女模・成人・兒童",
    title: "商品模特兒展示圖",
    summary: "提供清楚商品照片，製作模特兒手持、穿戴或使用商品的商業情境圖，不用另外安排真人拍攝。",
    price: "單張 NT$799",
    ...
    suitableFor: "保養品、口罩、包包、服飾、眼鏡、耳機、生活用品與食品品牌",
  },
  {
    id: "line-sticker",
    eyebrow: "店家・職業・人物角色",
    title: "LINE 貼圖客製",
    summary: "把店家常用回覆、職業情境或人物角色做成真正能日常使用的 LINE 貼圖。",
    price: "8 張限量價 NT$1,299",
    accent: "from-sky-500 to-cyan-500",
    icon: Sticker,
    deliverables: ["文字與使用情境規劃", "角色風格設計與細節整理", "透明 PNG、主圖、標籤圖", "LINE 規格 ZIP 與上架教學"],
    suitableFor: "飲料店、甜點店、社區管理、美業、工作室與個人角色",
  },
  {
    id: "business-card",
    eyebrow: "排版・QR Code・印刷",
    title: "名片設計＋代印",
    summary: "從版型挑選、資料排版到印刷宅配一次處理，適合剛開業或需要更新名片的人。",
  ...
  },
  {
    ...
    eyebrow: "小型品牌視覺延伸",
    title: "個人品牌與包裝圖稿",
    summary: "把品牌的顏色、字體與常用素材整理成一致風格，再延伸到貼紙、卡片與禮盒外觀。",
    price: "依項目報價",
...
const plans = [
  {
    ...
    price: "NT$299",
    suffix: "／單張",
    description: "先從一張最需要改善的商品照開始。",
    items: ["3 張 NT$799", "5 張 NT$1,199", "適合貼文、菜單與賣場"],
    href: "#product-image",
  },
  {
    title: "商品模特兒圖",
    price: "NT$799",
    suffix: "／單張",
    description: "提供商品照片，製作一位模特兒的手持、穿戴或使用情境。",
    items: ["同款 3 張 NT$1,999", "男模、女模、成人或兒童皆可", "含一次小幅修改"],
    href: "#model-product",
    featured: true,
  },
  {
    ...
    price: "NT$1,299",
    suffix: "／8張",
    description: "限前 3 名案例募集，完成後恢復原價 NT$1,999。",
    items: ["含主圖、標籤圖與 ZIP", "一次小幅修改", "上架流程教學"],
    href: "#line-sticker",
  },
  {
    title: "名片設計＋印刷",
    price: "NT$399",
    suffix: "／200張",
    description: "首波雙面水晶亮膜方案，價格已含宅配。",
    items: ["人工排版", "一次文字修改", "確認預覽後安排送印"],
    href: "#business-card",
  },
  {
    title: "品牌／禮盒視覺",
    price: "專案報價",
    suffix: "",
    description: "先確認使用項目、尺寸與印刷廠規格，再提供書面報價。",
    items: ["基礎品牌視覺", "貼紙、卡片與腰封", "禮盒平面圖稿"],
    href: "#brand-design",
  },
];
...
const workflow = [
  ["01", "說明需求", "提供產業、用途、尺寸、數量、參考風格與希望完成時間。"],
  ["02", "確認報價與訂金", "雙方確認交付檔案、修改次數、費用與交期，支付 50% 訂金後開始製作。"],
  ["03", "製作與預覽", "先提供加浮水印的預覽確認方向，依方案完成約定範圍內的修改。"],
  ["04", "付尾款並交付", "確認成品並付清尾款後，交付無浮水印高畫質檔案；印刷或上架方案會接續處理。"],
];
...
export default function DesignCommissionPage() {
  ...
  return (
    <>
      <SEO
        title="商品圖、虛擬模特兒、LINE貼圖與名片接案｜RxV 夢想創作工作室"
        description="RxV 提供商品圖升級、商品虛擬模特兒展示圖、LINE貼圖客製、名片設計印刷與品牌視覺服務。查看作品、價格、LINE 聯絡方式與合作流程。"
      ...
      <main className="min-h-screen w-full min-w-0 max-w-full overflow-x-hidden bg-[#fffaf2] pb-28 text-slate-900 md:pb-0">
            ...
            <div className="min-w-0">
              <div className="flex min-w-0 flex-wrap gap-2">
                <span className="inline-flex items-center gap-2 rounded-full border border-sky-200 bg-white px-3 py-1.5 text-sm font-bold text-sky-800 shadow-sm">
                  <Sparkles className="h-4 w-4" /> 小店與個人品牌視覺接案
                </span>
                <span className="inline-flex items-center gap-2 rounded-full border border-orange-200 bg-white px-3 py-1.5 text-sm font-bold text-orange-800 shadow-sm">
                  <BadgeCheck className="h-4 w-4" /> 作品、價格、流程一次看
                </span>
              </div>
              ...
              <p className="mt-6 max-w-3xl break-words text-base leading-7 text-slate-600 sm:text-lg sm:leading-8">
                商品照片不夠吸引人、需要模特兒手持或穿戴展示、貼圖不知道怎麼規劃，或名片與品牌素材風格不一致，都可以從目前最需要的一項開始。
              </p>
              ...
              {services.map((service) => {
                ...
                return (
                  <a
                    key={service.id}
                    href={`#${service.id}`}
                    className="group w-full min-w-0 rounded-3xl border border-slate-200 bg-white p-6 text-left shadow-sm transition hover:-translate-y-1 hover:border-sky-200 hover:shadow-md"
                  >
                    <span className={`inline-grid h-11 w-11 place-items-center rounded-2xl bg-gradient-to-br ${service.accent} shadow-lg`}>
                      <Icon className="h-5 w-5 text-white" />
                    </span>
                    <p className="mt-5 text-sm font-bold text-slate-500">{service.eyebrow}</p>
                    <h2 className="mt-1 text-xl font-black text-slate-900">{service.title}</h2>
                    <p className="mt-2 text-sm font-bold text-sky-700">{service.price}</p>
        ...
        <section className="mx-auto w-full min-w-0 max-w-7xl px-4 py-14 sm:px-8 lg:px-10 lg:py-20">
          <div className="min-w-0 max-w-3xl">
            <p className="text-sm font-black text-orange-700">服務項目</p>
            <h2 className="mt-2 text-3xl font-black tracking-tight sm:text-5xl">現在可以委託哪些設計？</h2>
            <p className="mt-4 text-base leading-8 text-slate-600">
              選擇目前最需要的服務即可；如果同時需要商品圖、名片或品牌素材，也能依實際用途安排組合方案。
            </p>
          </div>
                  ...
                  <div className="p-6 sm:p-8">
                    ...
                    {service.id === "model-product" ? (
                      <div className="mt-4 rounded-2xl border border-rose-100 bg-rose-50 p-4 text-sm leading-7 text-rose-950">
                        ...
                        <p className="mt-2 font-bold">同款商品 3 張不同模特兒或情境：NT$1,999。</p>
        ...
        <section className="mx-auto w-full min-w-0 max-w-7xl px-4 py-14 sm:px-8 lg:px-10 lg:py-20">
          <div className="min-w-0 max-w-3xl">
            <p className="text-sm font-black text-violet-700">品牌延伸設計</p>
            <h2 className="mt-2 text-3xl font-black tracking-tight sm:text-5xl">讓客戶一眼認出你的品牌</h2>
        ...
        <section className="border-y border-orange-100 bg-[#fff4df]">
          <div className="mx-auto w-full min-w-0 max-w-7xl px-4 py-14 sm:px-8 lg:px-10 lg:py-20">
            <div className="min-w-0 max-w-3xl">
              <p className="text-sm font-black text-orange-700">方案價格</p>
              <h2 className="mt-2 text-3xl font-black tracking-tight sm:text-5xl">選擇適合你的方案</h2>
              <p className="mt-4 leading-8 text-slate-600">以下為目前公開價格；確認用途、數量與交期後，會先說明完整費用再開始製作。</p>
            </div>
            <div className="mt-10 grid gap-5 md:grid-cols-2">
              {plans.map((plan) => (
                <a
            ...
            <div className="mt-6 rounded-2xl border border-orange-200 bg-white px-5 py-4 text-sm leading-7 text-slate-600">
              ...
              確認需求與完整報價後支付 50% 訂金開始製作；預覽確認並付清尾款後，交付無浮水印高畫質檔案。本服務不提供免費試做。
            </div>
          </div>
        </section>
          ...
          <div className="mx-auto w-full min-w-0 max-w-5xl px-4 py-14 sm:px-8 lg:py-20">
            <div className="text-center">
              <span className="inline-flex items-center gap-2 rounded-full bg-white px-4 py-2 text-sm font-black text-orange-700 shadow-sm">
                <Sparkles className="h-4 w-4" /> 不確定該選哪一項，也可以先詢問
              </span>
              <h2 className="mt-5 text-3xl font-black tracking-tight sm:text-5xl">告訴我你的用途，我會協助整理適合的做法。</h2>
              <p className="mx-auto mt-5 max-w-3xl leading-8 text-slate-600">
                可直接加 LINE 詢問，也能填寫表單後開啟 Gmail；收件人、主旨與需求會自動帶入。
              </p>
            </div>
            ...
            >
              <div className="grid min-w-0 grid-cols-1 gap-5 sm:grid-cols-2">
                ...
                <label className="block min-w-0">
                  ...
                  >
                    <option>商品圖升級</option>
                    <option>商品模特兒展示圖</option>
                    <option>LINE 貼圖客製</option>
                    <option>名片設計＋代印</option>
                    <option>個人品牌視覺</option>
                    <option>禮盒／包裝圖稿</option>
                    <option>還不確定，想先討論</option>
                  </select>
                </label>
                <label className="block min-w-0">
                ...
                <label className="block min-w-0">
                  ...
                  <input
                    ...
                    placeholder="例如：模特兒商品圖 1 張、貼圖 8 張"
                    className="min-h-[50px] w-full rounded-2xl border border-slate-200 bg-white px-4 outline-none transition focus:border-orange-400 focus:ring-4 focus:ring-orange-100"
                  />
                </label>
                <label className="block min-w-0">
              ...
              <label className="mt-5 block min-w-0">
                ...
                <textarea
                  ...
                  placeholder="可以說明喜歡的風格、目前遇到的問題，或貼上參考網址。"
