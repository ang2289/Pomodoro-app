  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        {/* 點數使用說明 */}
        <section className="mb-8">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">點數使用說明</h2>
          <div className="bg-white border border-gray-200 rounded-lg p-5 space-y-4">
            <div>
              <p className="text-gray-800 font-medium mb-2">🎁 新用戶體驗點數</p>
            ...
            <div>
              <p className="text-gray-800 font-medium mb-2">💳 付費購買點數</p>
              <p className="text-gray-700 leading-relaxed text-sm">
                付費購買之點數為永久點數，
                不限使用期限、不會過期，可長期累積使用。
              </p>
            ...
            <div>
              <p className="text-gray-800 font-medium mb-2">📌 點數扣除說明</p>
              <p className="text-gray-700 leading-relaxed text-sm">
                點數僅在實際使用 AI 服務時才會扣除，
                未使用不會產生任何費用。
              </p>
